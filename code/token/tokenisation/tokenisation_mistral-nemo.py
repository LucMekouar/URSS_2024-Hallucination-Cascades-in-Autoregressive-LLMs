# Script to tokenize and clean responses using the Mistral-Nemo-Base-2407 model.
...
# Load the Mistral-Nemo-Base-2407 tokenizer
model_id = "mistralai/Mistral-Nemo-Base-2407"
tokenizer = AutoTokenizer.from_pretrained(model_id)

# Load the CSV files
responses_file = "data_results/responses_mistral-nemo.csv"
...
output_file = "data_results/token/50.tokenized_mistral-nemo.csv"
